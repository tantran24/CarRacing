...
import { ColliderDebug } from "../components/ColliderDebug";

export function Circuit(props) {
    const { nodes, materials } = useGLTF(
        "../src/assets/3D/low_poly_tsukuba_circuit.glb"
    );

    const geometry = nodes.Object_82.geometry;
    ...
    // Update the mesh's position and rotation from the physics body
    // useFrame(() => {
    //     if (ref.current) {
    //         ref.current.position.copy(ref.current.position);
    //         ref.current.rotation.copy(ref.current.rotation);
    //     }
    // });
    ...
    return (
        <>
            ...
            />
            <ColliderDebug geometry={geometry} />
        </>
    );
}
